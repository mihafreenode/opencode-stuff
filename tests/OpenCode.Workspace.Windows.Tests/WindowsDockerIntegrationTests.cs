...
public sealed class WindowsDockerIntegrationTests
{
    ...
    public async Task FreshWorkspaceProvisioning_UsesNode22_WhenDockerAvailable()
    {
        ...
        try
        {
            ...
            Assert.Contains("# Generated by OpenCode Workspace Manager", composeYaml);
            ...
            Assert.Contains("# Generated by OpenCode Workspace Manager", environmentFile);
            ...
            Assert.Contains("# Generated by OpenCode Workspace Manager", shellInitScript);
            Assert.Contains("export STARSHIP_CONFIG=/opt/opencode-workspace/config/starship.toml", shellInitScript);
            Assert.Contains("# Generated by OpenCode Workspace Manager", attachWrapper);
