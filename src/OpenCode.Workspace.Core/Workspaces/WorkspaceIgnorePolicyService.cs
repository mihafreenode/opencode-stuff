...
{
    private static readonly string[] GeneratedFileHeaderPrefixes =
    [
    ...
    private static bool IsGeneratedEnvironmentFile(string normalizedPath, bool isDirectory, string fullPath)
    {
        ...
        return GeneratedFileHeaderPrefixes.Any(prefix => string.Equals(firstLine, prefix, StringComparison.Ordinal));
    }
