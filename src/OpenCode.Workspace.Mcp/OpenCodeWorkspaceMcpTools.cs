...
public sealed class OpenCodeWorkspaceMcpTools
{
    ...
    [McpServerTool(Name = "create_workspace"), Description("Start canonical LocalHost workspace creation. Poll get_operation for the created workspace result.")]
    public static async Task<CallToolResult> CreateWorkspace(
        ...
        LocalHostOperationStore operations)
        => await ExecuteAsync(() => operations.StartCreateWorkspaceAsync(templateId, workspaceName, destinationRoot), McpResults.OperationStarted, "Create workspace operation started.");
    ...
    public static async Task<CallToolResult> ProvisionWorkspace([Description("Workspace id")] string workspaceId, LocalHostOperationStore operations)
    ...
    public static async Task<CallToolResult> RunSmoke(
        ...
        => await ExecuteAsync(() => operations.StartSmokeRunAsync(templateId, timeout, artifactsRoot), McpResults.OperationStarted, "Smoke operation started.");
    ...
    [McpServerTool(Name = "cleanup_smoke_resources"), Description("Start canonical cleanup of labeled smoke-owned runtime resources. Poll get_operation for completion.")]
    public static async Task<CallToolResult> CleanupSmokeResources(
        ...
        LocalHostOperationStore operations = null!)
        => await ExecuteAsync(() => operations.StartCleanupSmokeResourcesAsync(dryRun, includeAll, runId), McpResults.OperationStarted, "Smoke cleanup operation started.");
    ...
    [McpServerTool(Name = "process_excel_artifact"), Description("Start canonical LocalHost XLSX processing. Poll get_operation for the output workbook and artifact reference.")]
    public static async Task<CallToolResult> ProcessExcelArtifact(string sourcePath, string? destinationWorkspaceId = null, string? processingTemplateId = null, string? outputLogicalName = null, LocalHostOperationStore operations = null!)
        => await ExecuteAsync(() => operations.StartProcessExcelArtifactAsync(sourcePath, destinationWorkspaceId, processingTemplateId, outputLogicalName), McpResults.OperationStarted, "Excel processing operation started.");
